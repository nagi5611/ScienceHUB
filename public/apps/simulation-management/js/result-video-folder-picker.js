...
export function initPrintVideoFolderPicker(options) {
  modalEl = document.getElementById('result-video-folder-modal');
  listEl = document.getElementById('result-video-folder-list');
  breadcrumbEl = document.getElementById('result-video-folder-breadcrumb');
  hintEl = document.getElementById('result-video-folder-hint');
  confirmBtn = document.getElementById('result-video-folder-confirm');

  onSelectCallback = options.onSelect;
  getGroupRoots = options.getGroupRoots;

  document.getElementById('result-video-folder-modal-close')?.addEventListener('click', closePicker);
  document.getElementById('result-video-folder-cancel')?.addEventListener('click', closePicker);
