  ...
  try {
    ...
    if (method === "GET" && segments[0] === "fds-requests" && segments[1] === "config") {
      return json({
        ...
        instance_family: FDS_INSTANCE_FAMILY,
    ...
    if (
      ...
      const sizing = pickFdsInstanceType(Number.isFinite(mpiRaw) ? mpiRaw : 1);
    ...
    if (method === "GET" && segments[1] === "ec2-instances" && segments.length === 2) {
      ...
      return json({ instance_family: FDS_INSTANCE_FAMILY, instances });
    }
