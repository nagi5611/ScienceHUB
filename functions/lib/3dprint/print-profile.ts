...
/** プロフィールが予約可能な状態か */
export function isPrintProfileComplete(profile: PrintUserProfile): boolean {
  return Boolean(
    profile.homeroom &&
...
/** users テーブルから3D印刷プロフィールを取得 */
export async function getPrintUserProfile(
  db: D1Database,
  userId: string
