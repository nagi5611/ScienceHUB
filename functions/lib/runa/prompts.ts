...
## 方針
- 社内ファイルは storage_search 系。Web は exa_search（意味・自然言語）と web_search（Google SERP 風）を使い分け、参考画像は web_image_search。
- web_search / exa_search の結果は出典 URL を Markdown リンクで示す。
