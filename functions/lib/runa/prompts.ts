...
## 方針
- 社内ファイルは storage_search 系、Web の一般情報は web_search / serper_search / brave_search（期間指定が必要なら serper_search または brave_search）、参考画像は web_image_search / serper_image_search / brave_image_search を使い分ける。
- web_search / serper_search / brave_search の結果は出典 URL を Markdown リンクで示す。
