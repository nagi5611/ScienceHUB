...
const TOOL_STATUS_LABELS: Record<string, string> = {
  ...
  serpbase_search: "Web を検索しています（SerpBase）…",
  exa_search: "Exa で Web を検索しています…",
  serper_search: "Web を検索しています（Serper）…",
  brave_search: "Web を検索しています（Brave）…",
  serpbase_image_search: "画像を検索しています（SerpBase）…",
  serper_image_search: "画像を検索しています（Serper）…",
  brave_image_search: "画像を検索しています（Brave）…",
  multi_search: "マルチ検索を実行しています…",
